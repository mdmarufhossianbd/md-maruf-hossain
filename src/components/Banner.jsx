    ...
    return (
        <div className="lg:flex items-center justify-between max-w-7xl mx-auto my-20 px-10">
            <div className="flex flex-col justify-center lg:w-1/2 w-full">
                <p className="text-3xl md:text-5xl mb-2">Hi, I'm Md Maruf Hossain, <span className="font-semibold text-gradient-to-r from-green-400 to-blue-500 text-[#C961DE]">Professional Frontend Developer</span>.</p>
                <TypewriterForBanner />
